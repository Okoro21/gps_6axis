...
osThreadId_t microROS_txHandle;
const osThreadAttr_t microROS_tx_attributes = {
  .name = "microROS_tx",
  .stack_size = 3000 * 4,
...
/* USER CODE BEGIN Header_tx_data */
/**
  * @brief  Function implementing the microROS_tx thread.
